...
1. How would you describe acessibility on the web to someone new to programming?
    Accessibility on the web is making the website accessible to people with various restrictions, like : those with slow internet connection, those on mobile devices, those with auditory, cognitive, neurological, or physical disabilities, and those with visual needs.

2. Talk about 3 different things you can do to ensure your website is accessible.
    1.	Use scalable units, for example, font size 62.5%
    2.	Use semantic tags
    3.	Use contrasting colors

3. How would you explain the concept of a variable to someone new to programming?
    A variable is a way that we can store data to use later

4. What is the purpose of using functions in code?
    A function enables us to perform a task
